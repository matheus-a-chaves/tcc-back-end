...
public interface CampeonatoRepository extends JpaRepository<Campeonato, Long> {
    ...
    @Query(value="select c.* from campeonato c inner join campeonato_usuario cu on C.id = CU.campeonato_id where cu.usuario_id  = :usuarioId AND c.codigo_modalidade = :modalidadeId", nativeQuery = true)
